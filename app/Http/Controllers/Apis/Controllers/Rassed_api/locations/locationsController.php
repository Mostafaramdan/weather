...
namespace App\Http\Controllers\Apis\Controllers\Rassed_api\locations;
...
use App\Http\Controllers\Rassed_api\locations\locationsController as Rassed_api_locations;
class locationsController extends Controller
{
    ...
    public function locations(Request $request)
    {
        ...
        $result = $this->get_chk_if_locations_exist($request);
        ...
        if ($result) {
            ...
            $rassed   = new Rassed_api_locations($this->prepare_request_to_send($request));
    ...
    public function get_chk_if_locations_exist($request)
    {
        $location = location::where('details', $request->details)
