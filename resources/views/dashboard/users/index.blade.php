...
@section ('content')
    ...
    <div  id="alert">
        ...
        <div class="flex-grow-1"></div>
              <div class="m-2">
                <button class="btn btn-primary px-5 add" onClick="event.preventDefault();" data-toggle="modal" data-target="#addEdit-new-modal"> إضافة  مستخدم جديد <i class="ml-2 fas fa-plus-circle"></i></button>
              </div>
          </div>
