    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form  id="createUpdate" action="{{route('dashboard.'.Request::segment(2).'.createUpdate')}}" method="POST">
                    ...
                    <div class="form-group">
                        <label for="contentAr" class="col-form-label"> ادخل محتوي الاشعار:</label>
                        <input type="text" class="form-control" name="contentAr">
                    </div>
                    <div class="form-group" >
                        <div class="progress " >
            ...
            <div class="modal-footer">
                ...
                <button type="button"  class="btn btn-success submit" id="submit">ارسال</button>
            </div>
