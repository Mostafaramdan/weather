            ...
            <div class="modal-body">
                <form  id="createUpdate" action="{{route('dashboard.'.Request::segment(2).'.createUpdate')}}" method="POST">
                    ...
                    <div class="form-group">
                        <label for="titleAr" class="col-form-label">ادخل العنوان :</label>
                        <input type="text" class="form-control" name="titleAr">
                    </div>
                    <div class="form-group contentAr-ckEditor">
                        <label for="contentAr" class="col-form-label">ادخل محتوي الخبر :</label>
                        @include('dashboard.layouts.ckEditor',['field'=>'contentAr'])
                    </div>
                    <div class="form-group" >
                        <label for="regionId" class="col-form-label">اختر نوع الخبر (يومي / اسبوعي):</label>
                        <select  class="form-control" name="periodic">
                            <option value="daily">يومي</option>
                            <option value="weakly">اسبوعي</option>
                        </select>
                    </div>
                    <div class="row mr-10" >
