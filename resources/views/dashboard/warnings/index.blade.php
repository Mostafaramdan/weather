    ...
    <div  id="alert">
        ...
        <form class="mb-4" id="getOptions">
                ...
                <div class="m-2">
                  ...
                  <div class="m-2">
                    <select class="custom-select" name="sortBy">
                        ...
                        <option value="titleAr"> المحتوي</option>
            ...
            <div class="flex-grow-1"></div>
                <div class="m-2">
                  <button class="btn btn-primary px-5 add" onClick="event.preventDefault();" data-toggle="modal" data-target="#addEdit-new-modal"> إضافة تحذير جديد <i class="ml-2 fas fa-plus-circle"></i></button>
                </div>
            </div>
          <div class="table-responsive">
          <table class="table bg-light mb-4 tableInfo" id="tableInfo" dir="rtl">
            @include('dashboard.warnings.tableInfo')
          </table>
        </div>
      ...
      <!-- Large modal -->
      @include('dashboard.warnings.viewModal')
      <!-- end Large modal -->

      <!-- addEdit new modal -->
        @include('dashboard.warnings.addEditModal')
      <!-- end add user modal -->
